...
@section('content')
    ...
    <div id="main">
        ...
        <div class="d-flex justify-content-between gap-2">
            {{-- page title --}}
            <h2 class="m-0">Social Pensions</h2>
            ...
            <div class="btn-toolbar gap-2" role="toolbar">
                <div class="btn-group" role="group">
                    ...
                    {{-- register citizen --}}
                    <a href="/pensions/apply" class="btn btn-secondary" data-has-tooltip="true" data-bs-placement="left" title="Apply social pension">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                            <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z" />
                        </svg>
                        <span class="visually-hidden">Apply Social Pension</span>
                    </a>
