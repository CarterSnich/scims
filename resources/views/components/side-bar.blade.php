...
<aside id="sidebar">
    <div class="d-flex h-100 flex-column flex-shrink-0 p-3 bg-light">
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            @if (auth()->user()->type == 'admin')
                <li>
                    <a href="/citizens/delisted" class="d-flex flex-column nav-link @if (Request::is('citizens/delisted')) active @endif">
                        <div class="d-flex">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-person-dash me-3 link-dark" viewBox="0 0 16 16">
            ...
            <li>
                <a href="/barangays" class="d-flex flex-column nav-link @if (Request::is('barangay')) active @endif">
                    <div class="d-flex">
