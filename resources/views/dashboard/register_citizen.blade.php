...
@section('content')
    <div id="main">
        ...
        <hr>
        <div id="form-wrapper">
            <form id="registration-form" class="d-flex flex-column px-3 pb-3 gap-5 needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                @method('POST')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 d-grid px-5 gap-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <select class="form-select @error('barangay') is-invalid @enderror" name="barangay" value="{{ old('barangay') }}" required>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <label for="age" class="h3 form-label text-info">Gender</label>
                            </div>
                            <div class="col-6">
